...
<html>
  <head>
    ...
    <title>My JSP 'work_title_manage2.jsp' starting page</title>
  ...
  <body>
   ...
   <br>
    ...
    <form action="work_title_manage2_2.jsp">
     <table width="700px">
    <tr height="50px">
    <td width="200px" align="center">修改个人信息</td>
    <td align="center">请选择此题所对应的课程名称：</td>
    </tr>
    <tr height="50px">
    ...
    <td align="center">请选择此题所对应的作业类型</td>
    </tr>
    <tr height="50px">
